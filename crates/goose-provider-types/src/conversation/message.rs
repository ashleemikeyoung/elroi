...
/// Locally verified security of the connection that carried an inference response.
/// Never derive this from model output, response headers, or a provider's name.
#[derive(Clone, Copy, PartialEq, Eq, Serialize, Deserialize, Debug)]
#[serde(rename_all = "snake_case")]
pub enum InferenceSecurity {
    AttestedTee,
}
...
pub struct MessageMetadata {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub inference_security: Option<InferenceSecurity>,
