...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default ElRoi starts a local backend. Use this to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. ElRoi checks /status and connects to /acp under this base.',
  },
  workingDir: {
  ...
  workingDirPlaceholder: {
    ...
    defaultMessage: '/home/elroi/workspace',
  },
  workingDirHelp: {
  ...
  restartNote: {
    ...
    defaultMessage: 'Changes apply to new chat windows. Restart ElRoi to update existing windows.',
  },
  urlProtocolError: {
