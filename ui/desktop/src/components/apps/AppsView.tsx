...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'Applications from your MCP servers and Apps built by ElRoi itself. You can ask it to create new apps through the chat interface and they will appear here.',
  },
  loading: {
    id: 'appsView.loading',
